...
import json
request_file = '/Users/thiagoferreira53/Desktop/CIMMYT/EBS/template_folder/new.JSON'  # temporary for testing

with open(request_file) as f:
        request_params = json.load(f)

analysis_request = DSSAT_AnalysisRequest(requestId=1, outputFolder='/Users/thiagoferreira53/Desktop/CIMMYT/EBS/test_output_folder', **request_params)
